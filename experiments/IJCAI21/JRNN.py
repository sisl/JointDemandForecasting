...
#loc, past_dims, fut_dims, epochs, seed = (1, 24, 8, 300, 0)
#loc, past_dims, fut_dims, epochs, seed = (9, 24, 8, 300, 0)

loc, past_dims, fut_dims, epochs, seed = (1, 8, 12, 300, 0)
loc, past_dims, fut_dims, epochs, seed = (9, 8, 12, 300, 1)
loc, past_dims, fut_dims, epochs, seed = (1, 16, 12, 300, 3)
loc, past_dims, fut_dims, epochs, seed = (9, 16, 12, 300, 1)
loc, past_dims, fut_dims, epochs, seed = (1, 24, 12, 300, 0)
loc, past_dims, fut_dims, epochs, seed = (9, 24, 12, 300, 2)
...
# train ll
print(nll(ss_gmmlstm(X_train),Y_train))
